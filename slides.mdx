...
<ul>
  <li><Emoji name="dropbox.svg"/> Dropbox Engineer</li>
  <li>🗽 NYC</li>
  <li><a href="https://theconsolelog.com">🎧 The Console Log</a></li>
  <li><a href="https://twitter.com/MatthewGerstman"><Emoji name="twitter.png"/> @MatthewGerstman</a></li>
</ul>

---
# <Emoji name="twitter.png" height={70} /> [@MatthewGerstman](https://twitter.com/MatthewGerstman)
...
---
<TallImage src='https://d2mxuefqeaa7sj.cloudfront.net/s_4BCCC39553ADA99C63657514F94123B76AE4DD2605D4D53BC7464B3EB47ACAE9_1543701279307_giphy-7.gif' />
---
...
---
Consider: Any number you say will be an immediate upper bound, any number they say will be a lower bound.
---
They will chip away at that number throughout the interview process
---
Let's wait to see if this is a godo fit before we discuss comp
---
# Next Secret

---
# Practice saying that biggest number you're comfortable saying with a straight face. 
...
# Express concern about anything intangible: Start date, team, etc.
 - Even if you're okay with it make them think you're giving them something
---
# Have a counter offer
---
...
:dropbox dbx db: Dropbox Engineer
🗽 NYC
:js-guild: [JS Guild](https://twitter.com/Dropbox/status/1058417224602476544)
:twitter: [@MatthewGerstman](https://twitter.com/MatthewGerstman)
